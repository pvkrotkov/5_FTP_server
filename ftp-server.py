#Админьские права - имя admin пароль 123
import filemanager_func as f
import socket
from bcrypt import checkpw, hashpw, gensalt
import threading
from contextlib import closing
from perep_func import poluch, otprav, calc_key#, Number_To_Fraze
...
signal={'chdirr':'','copyCS': f.sendd, 'copySC': f.recvv, 'openn': f.open_file, 'pwdd': f.tekush, 'lss': f.iz_direk, 'mkdirr': f.sozd_direk, 'remdirr': f.kill_it, 'touchh': f.stroi, 'dell': f.exterminate, 'zipuy': f.zazipovat, 'dezip': f.razzipovka, 'movetoo': f.movetoo, 'renamee': f.renamee, 'copyfilee': f.copy_file, 'copytoo': f.copy_folder}
